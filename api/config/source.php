...
//	private $mysql_database='computer'; //改成自己的mysql数据库名
	...
	private $mysql_server_name='134.175.41.220:3306'; //改成自己的mysql数据库服务器
 
	private $mysql_username='computer'; //改成自己的mysql数据库用户名
 
	private $mysql_password='sll123456'; //改成自己的mysql数据库密码
